...
- (void)viewDidLoad {
    ...
    self.view.unTouchRect = CGRectMake(0, 0, CGRectGetWidth(self.view.frame), kSafeAreaNavHeight);
...
- (UIView *)bgView {
    if (!_bgView) {
        ...
        _bgView.frame = CGRectMake(0, CGRectGetMaxY(self.searchBar.frame) + kSafeAreaNavHeight, SCREEN_WIDTH, SCREEN_HEIGHT - self.searchBar.frame.size.height - (iPhoneX ? 44 : 20));
